...
public class BlockCustomWall extends Block implements IHasModel
{
    ...
    public BlockCustomWall(String name, Material material, float hardness, float resistance, SoundType type)
    {
        super(material);
        ...
        this.setCreativeTab(Main.USELESSORESTAB);
